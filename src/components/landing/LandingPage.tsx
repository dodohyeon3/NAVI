...
const SCREENS = [
  ...
  { src: '/landing/shot-chart-ind.png', label: '분석 도구 통합',  sub: 'RSI · MACD · 볼린저밴드 일괄 표시' },
...
// ── TitleBar — 브라우저 크롬 바 ───────────────────────────────
function TitleBar({ small = false }: { small?: boolean }) {
  const h = small ? 28 : 36
  const d = small ? 9  : 12
  const g = small ? 5  : 6
  return (
    <div style={{
      ...
      padding: `0 ${small ? 10 : 14}px`, gap: g, flexShrink: 0,
    }}>
      ...
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center' }}>
        <div style={{
          ...
          color: 'rgba(248,249,247,0.30)', fontSize: small ? 9 : 10,
...
function NaviButterfly({
  ...
  return (
    <svg
      viewBox="0 0 512 512" width={size} height={size} fill={color} aria-hidden="true"
...
export function LandingPage() {
  ...
  const zoomScale    = useTransform(zoomProgress, [0, 0.7], [0.72, 1.0])
  const zoomRadius   = useTransform(zoomProgress, [0, 0.7], [14,   0  ])
  const chromeOpacity = useTransform(zoomProgress, [0.35, 0.65], [1,  0  ])
  const ctaOpacity   = useTransform(zoomProgress, [0.65, 1.0], [0,   1  ])
  const ctaY         = useTransform(zoomProgress, [0.65, 1.0], [32,  0  ])
    ...
    <main style={{ background: BG, color: TEXT, overflowX: 'hidden' }}>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(ellipse 70% 55% at 50% 25%, rgba(45,65,152,0.22) 0%, transparent 65%)',
        }} />
        {/* Butterfly — right */}
        <NaviButterfly
          size={320} opacity={0.05} color="#2D4198" rotate={16}
        ...
        >
          ...
          <div style={{
            ...
            <div style={{
              borderRadius: 14,
              border: '1px solid rgba(38,53,88,0.88)',
              overflow: 'hidden', background: '#030617',
              boxShadow: '0 40px 100px rgba(0,0,0,0.82), 0 0 80px rgba(45,65,152,0.22)',
            }}>
              <TitleBar />
              {/* Logo screen */}
              <div style={{
                ...
                <img
                  src="/navi-logo-typo.svg"
                  alt="NAVIchart"
                  draggable={false}
                  style={{ width: 'clamp(120px, 22%, 200px)', opacity: 0.94 }}
                />
              </div>
            </div>
            {/* Monitor stand */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <div style={{ width: 2, height: 22, background: 'rgba(38,53,88,0.55)' }} />
              <div style={{ width: 90, height: 5, borderRadius: 3, background: 'rgba(38,53,88,0.40)' }} />
            </div>
          </div>
          ...
          >
            ...
            <div style={{ width: 1, height: 28, background: `linear-gradient(to bottom, ${MUTED}, transparent)` }} />
          </motion.div>
        </motion.div>
      </section>

      {/* ══ Section 2 — Product sequence (PC: sticky scroll) ════ */}

      {/* PC: sticky scroll zone */}
      <div
        ref={seqRef}
        className="hidden sm:block"
        style={{ height: `${SCREENS.length * 100}vh`, position: 'relative' }}
      >
        <div style={{
                  ...
                  {activeScreen === 0 ? (
                    ...
                    >
                      <img
                        ...
                        draggable={false}
                        style={{ width: '32%', maxWidth: 180, opacity: 0.92 }}
                      />
                    </motion.div>
                  ) : (
                    <motion.img
      ...
      {/* Mobile: static screenshot stack */}
          ...
          {SCREENS.filter(s => s.src).map((screen, i) => (
            <motion.div key={i} {...fadeUp(i * 0.07)}>
              <div style={{ marginBottom: 12 }}>
                ...
                <p style={{ fontSize: 16, fontWeight: 800, color: TEXT, marginBottom: 4 }}>
                  {screen.label}
                </p>
                <p style={{ fontSize: 12, color: MUTED }}>{screen.sub}</p>
              </div>
              <div style={{
                borderRadius: 10, overflow: 'hidden',
                border: '1px solid rgba(38,53,88,0.75)',
      ...
      {/* ══ Section 3 — Interactive Learning ═══════════════════ */}
      <section style={{
        ...
        <div style={{
          ...
          <div>
              ...
              {(['Observe.', 'Learn.', 'Think.'] as const).map((word, i) => (
                <motion.div
                  ...
                  style={{
                    ...
                    color: `rgba(248,250,252,${1 - i * 0.28})`,
                  }}
                >
                  {word}
                </motion.div>
            ...
            <motion.p
              {...fadeUp(0.35)}
              style={{ fontSize: 14, color: MUTED, lineHeight: 1.85, maxWidth: 340, wordBreak: 'keep-all' }}
            >
          ...
          {/* Right: tutorial screenshot */}
          <motion.div {...fadeUp(0.12)}>
            <div style={{
              borderRadius: 12, overflow: 'hidden',
              border: '1px solid rgba(38,53,88,0.72)',
              boxShadow: '0 28px 72px rgba(0,0,0,0.68)',
            }}>
              <TitleBar small />
              <img
                src="/landing/shot-tutorial.png"
                alt="NAVIchart 인터랙티브 학습 화면"
                draggable={false}
                style={{ width: '100%', height: 'auto', display: 'block' }}
              />
            </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
            <motion.div {...fadeUp(0.08)}>
              ...
              <p style={{
                fontSize: 14, color: MUTED, lineHeight: 1.85,
      ...
      {/* ══ Section 5 — Learning content grid ══════════════════ */}
      <section style={{
        padding: 'clamp(120px, 15vh, 180px) clamp(16px, 4vw, 48px)',
        maxWidth: 1100, margin: '0 auto',
      }}>
        ...
        <div style={{
          ...
          >
            <motion.div style={{
              ...
              {/* Chrome fades out as frame expands */}
              <motion.div style={{ opacity: chromeOpacity, overflow: 'hidden' }}>
                <TitleBar />
              </motion.div>
              <img
          ...
          {/* CTA overlay (appears after zoom) */}
          <motion.div style={{
            position: 'absolute', inset: 0,
            display: 'flex', flexDirection: 'column',
            alignItems: 'center', justifyContent: 'center',
            opacity: ctaOpacity,
            background: 'rgba(3,6,23,0.80)',
            backdropFilter: 'blur(12px)',
            pointerEvents: 'none',
          }}>
            <motion.div style={{ y: ctaY, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32 }}>
              <img
                src="/navi-logo-typo.svg" alt="NAVIchart"
                draggable={false}
                style={{ height: 28, width: 'auto', opacity: 0.65 }}
              />
              <h2 style={{
              ...
              {/* Button needs pointer-events restored */}
              <div style={{ pointerEvents: 'auto' }}>
                <Link
                  ...
                  style={{
                    ...
                    boxShadow: '0 4px 32px rgba(91,127,255,0.38)',
      ...
      {/* ══ Final CTA (fallback for those who scroll past zoom) ═ */}
      <section style={{
        ...
        <NaviButterfly
          size={240} opacity={0.05} color="#2D4198" rotate={8}
        ...
        <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 32 }}>
          <motion.div {...fadeUp(0)}>
            <img
              src="/navi-logo-typo.svg" alt="NAVIchart"
              draggable={false}
              style={{ height: 30, width: 'auto', opacity: 0.65 }}
            />
          </motion.div>
